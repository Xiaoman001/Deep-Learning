...
def get_parser():
    ...
    parser.add_argument(
        '--test_set', default=1,
        help='Set this value to 0~44 for ETH-univ, ETH-hotel, UCY-zara01, UCY-zara02, UCY-univ')
    parser.add_argument(
    ...
    parser.add_argument(
        '--train_model', default='sralstm',
        help='Your model name')
    parser.add_argument(
        '--load_model', default=133,  # 0:243, 1:133, 2:208, 3:221, 4:228
        help="load model weights from this index before training or testing")
    parser.add_argument(
        '--pretrain_model', default='sralstm',
    ...
    parser.add_argument(
        '--val_batch_size', default=1)
    parser.add_argument(
        '--test_batch_size', default=1)
    parser.add_argument(
        '--show_step', default=400)
    parser.add_argument(
