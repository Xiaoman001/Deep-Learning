...
class DataLoader_bytrajec2():
    def __init__(self,  args):
        ...
        if self.args.dataset == 'eth5':
            ...
            self.data_dirs = ['./data/eth/univ', './data/eth/hotel', 
                              ...
                              './data/ucy/univ/students003', 'data/ucy/univ/students001',
        ...
        self.train_data_file = os.path.join(self.args.save_dir, "train_trajectories.cpkl")   # 路径拼接
    ...
    def rotate_shift_batch(self, batch_data, ifrotate=True):
        ...
        # print(batch.shape, shift_value.shape)
