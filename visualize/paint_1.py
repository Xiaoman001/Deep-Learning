...
# SRAI-LSTM-HOTEL; SR-LSTM-HOTEL; S-GAN-HOTEL
...
if test_id == 0 or test_id == 1:
    ...
    gx4, gy4, px4, py4 = gy4, gx4, py4, px4
...
for k in range (Predict):
    ...
    for i in range(gx1.shape[-1]):
        if i in [0, 1]:
            ...
            plt.plot(px1[6:(8+k+1), i], py1[6:(8+k+1), i], "g--", lw=1.5)
            plt.plot(px2[6:(8+k+1), i], py2[6:(8+k+1), i], "y--", lw=1.5)
